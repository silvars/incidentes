...
<tr>
	...
	<td>${team.rating}</td>
	<td>
	<a href="${pageContext.request.contextPath}/pages/team/edit/${team.id}.html">Edit</a><br>
	<a href="${pageContext.request.contextPath}/pages/team/delete/${team.id}.html">Delete</a><br>
	</td>
</tr>
